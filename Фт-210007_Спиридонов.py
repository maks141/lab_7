...
# Ввод данных полей
while True:
    k = int(input('Введите k (число по вертикали 1-го поля): ')) - 1
    l = int(input('Введите l (число по горизонтали 1-го поля): ')) - 1
    m = int(input('Введите m (число по вертикали) 2-го поля: ')) - 1
    n = int(input('Введите n (число по горизонтали) 2-го поля: ')) - 1
...
# Создание шахматного поля с помощью матрицы (1 - черное, 0 - белое)
area = np.full((8, 8), 1)
...
# Вывод шахматного поля с момощью матрицы
...
name_list = ['слон', 'ладья', 'ферзь', 'конь']
while True:
    name_area = input('Укажите наименование фигуры для поля (k, l) (слон, ладья, ферзь или конь): ').lower()
    if name_area not in name_list:
        print('Введите правильное название фигуры (слон, ладья, ферзь или конь)')
        continue
    else:
        break
